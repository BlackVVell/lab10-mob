    ...
    public void updateNotification() {
        ...
        notifyBuilder.setStyle(
                new NotificationCompat.InboxStyle()
                        .addLine("This is the first line of the inbox")
                        .addLine("This is the second line of the inbox")
                        .addLine("This is the third line of the inbox")
                        .setBigContentTitle("Notification become a bit complicated!")
